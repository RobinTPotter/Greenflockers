...
public class Arg3dView extends SurfaceView {


    private SurfaceHolder surfaceHolder;
    private Arg3dThread myThread;
    ...
    public Arg3dView(Context context) {
        super(context);
        init();
    }

    public Arg3dView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public Arg3dView(Context context, AttributeSet attributeSet, int defStyle) {
